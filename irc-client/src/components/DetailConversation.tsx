// src/components/DetailConversation.tsx
...
export default function DetailConversation({
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%", p: 2, bgcolor: "#1e1e1e" }}>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2, pl: 1, pr: 1 }}>
          ...
          <Fade in timeout={500} key={i}>
            <ListItem
              sx={{
                ...
                p: 1.5,
                bgcolor: '#292929',
                // Extra animation defined in index.css (fadeIn keyframes)
                animation: 'fadeIn 0.5s ease-out'
              }}
            >
              <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%', mb: 0.5 }}>
                <Typography variant="subtitle2" sx={{ fontWeight: 'bold', color: '#bb86fc' }}>
                  {message.sender}
                </Typography>
